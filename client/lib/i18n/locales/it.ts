...
const it: Partial<Record<TranslationKey, string>> = {
    ...
    "booking.steps.payment": "Riepilogo",
    ...
    "booking.step4.banner.body.pending":
      "Il ristorante confermerà la tua prenotazione via SMS o e-mail a breve.",
    ...
    "menu.preview.see_full_menu": "Vedi menu completo",
    "menu.preview.categories_suffix": "categorie",
    "menu.preview.more_item": "piatto in più",
    "menu.preview.more_items": "piatti in più",
    "menu.vote.favorite_badge": "Preferito",
    "menu.vote.login_required": "Accedi per votare",
    "review.dishes_tested": "Quali piatti hai provato?",
    "review.dishes_vote_hint": "Metti like o dislike ai piatti che hai assaggiato",
    ...
    "reset_password.error.weak_password": "Questa password è troppo comune e facile da indovinare. Scegline una più sicura.",
    ...
    // Ambassador Program
    "ambassador.program.title": "Programma Ambasciatori",
    "ambassador.program.subtitle": "Recluta ambasciatori e premiali per ogni prenotazione generata",
    "ambassador.program.create": "Crea un programma",
    "ambassador.program.edit": "Modifica programma",
    "ambassador.program.config": "Configurazione del programma",
    "ambassador.program.config_desc": "Parametri del tuo programma ambasciatori",
    "ambassador.program.reward_description": "Descrizione del premio",
    "ambassador.program.reward_placeholder": "Es.: Una cena per 2 in omaggio",
    "ambassador.program.conversions_required": "Conversioni necessarie",
    "ambassador.program.conversions_hint": "Numero di prenotazioni confermate per sbloccare il premio",
    "ambassador.program.validity_days": "Validità (giorni)",
    "ambassador.program.validity_hint": "Durata per utilizzare il premio una volta sbloccato",
    "ambassador.program.max_beneficiaries": "Max beneficiari / mese",
    "ambassador.program.confirmation_mode": "Modalità di conferma",
    "ambassador.program.confirmation_manual": "Manuale (dalla dashboard)",
    "ambassador.program.confirmation_qr": "Codice QR (scansione alla reception)",
    "ambassador.program.active": "Programma attivo",
    "ambassador.program.inactive": "Programma inattivo",
    "ambassador.program.no_program": "Nessun programma ambasciatori",
    "ambassador.program.no_program_desc": "Crea un programma per reclutare ambasciatori tra i tuoi clienti.",
    "ambassador.program.created": "Programma creato con successo!",
    "ambassador.program.updated": "Programma aggiornato",
    "ambassador.program.activated": "Programma attivato",
    "ambassador.program.deactivated": "Programma disattivato",

    "ambassador.applications.title": "Candidature",
    "ambassador.applications.all": "Tutte",
    "ambassador.applications.pending": "In attesa",
    "ambassador.applications.accepted": "Accettate",
    "ambassador.applications.rejected": "Rifiutate",
    "ambassador.applications.accept": "Accettare",
    "ambassador.applications.reject": "Rifiutare",
    "ambassador.applications.empty": "Nessuna candidatura",
    "ambassador.applications.rejection_reason": "Motivo del rifiuto",
    "ambassador.applications.confirm_accept": "Conferma accettazione",
    "ambassador.applications.confirm_reject": "Conferma rifiuto",

    "ambassador.conversions.title": "Conversioni",
    "ambassador.conversions.confirm_presence": "Presente",
    "ambassador.conversions.reject": "Assente",
    "ambassador.conversions.pending": "In attesa",
    "ambassador.conversions.confirmed": "Confermata",
    "ambassador.conversions.rejected": "Rifiutata",
    "ambassador.conversions.expired": "Scaduta",
    "ambassador.conversions.suspicious": "Sospetta",
    "ambassador.conversions.empty": "Nessuna conversione",

    "ambassador.rewards.title": "Premi",
    "ambassador.rewards.mark_claimed": "Consumare",
    "ambassador.rewards.active": "Attivo",
    "ambassador.rewards.claimed": "Consumato",
    "ambassador.rewards.expired": "Scaduto",
    "ambassador.rewards.claim_code": "Codice",
    "ambassador.rewards.empty": "Nessun premio",
    "ambassador.rewards.consumed": "Premio consumato con successo",

    "ambassador.stats.title": "Statistiche",
    "ambassador.stats.total_ambassadors": "Ambasciatori attivi",
    "ambassador.stats.pending_applications": "Candidature in attesa",
    "ambassador.stats.conversions_this_month": "Conversioni questo mese",
    "ambassador.stats.active_rewards": "Premi attivi",
    "ambassador.stats.total_conversions": "Conversioni",
    "ambassador.stats.conversion_rate": "Tasso di conversione",
    "ambassador.stats.rewards_distributed": "Premi distribuiti",
    "ambassador.stats.rewards_claimed": "Premi consumati",
    "ambassador.stats.top_ambassadors": "Top 5 ambasciatori",

    // Ambassador Consumer
    "ambassador.consumer.join_program": "Unisciti al programma",
    "ambassador.consumer.application_sent": "Candidatura inviata",
    "ambassador.consumer.you_are_ambassador": "Sei ambasciatore",
    "ambassador.consumer.application_rejected": "Candidatura rifiutata",
    "ambassador.consumer.in_progress": "in corso",
    "ambassador.consumer.unlocked": "sbloccati",
    "ambassador.consumer.confirmed_reservations": "prenotazioni confermate",
    "ambassador.consumer.view_qr": "Vedi il mio QR code",
    "ambassador.consumer.your_reward": "Il tuo premio",
    "ambassador.consumer.copied": "Copiato!",
    "ambassador.consumer.expires_on": "Scade il",
    "ambassador.consumer.used_on": "Usato il",
    "ambassador.consumer.empty_title": "Nessun programma",
    "ambassador.consumer.empty_desc": "Non hai ancora aderito a nessun programma ambasciatori",
    "ambassador.consumer.pending_validation": "In attesa di validazione",
    "ambassador.consumer.applied_on": "Candidatura del",
    "ambassador.consumer.programs_in_progress": "Programmi in corso",
    "ambassador.consumer.pending_applications": "Candidature in attesa",
    "ambassador.consumer.unlocked_rewards": "Premi sbloccati",
    "ambassador.consumer.rewards_history": "Storico premi",

    // Ambassador Admin
    "ambassador.admin.title": "Programma Ambasciatori",
    "ambassador.admin.subtitle": "Panoramica dei programmi, conversioni e rilevamento frodi",
    "ambassador.admin.overview": "Panoramica",
    "ambassador.admin.programs": "Programmi",
    "ambassador.admin.conversions": "Conversioni",
    "ambassador.admin.fraud": "Frode",
    "ambassador.admin.active_programs": "Programmi attivi",
    "ambassador.admin.total_conversions": "Conversioni totali",
    "ambassador.admin.rewards_distributed": "Premi distribuiti",
    "ambassador.admin.suspicious_conversions": "Conversioni sospette",
    "ambassador.admin.flag_suspicious": "Segnala come sospetto",
    "ambassador.admin.force_confirm": "Forzare conferma",
    "ambassador.admin.suspects_only": "Solo sospetti",
    "ambassador.admin.all_statuses": "Tutti gli stati",
    "ambassador.admin.filter_active": "Attivi",
    "ambassador.admin.filter_inactive": "Inattivi",
    "ambassador.admin.filter_all": "Tutti",
};
