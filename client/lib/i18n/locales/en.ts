...
const en: Partial<Record<TranslationKey, string>> = {
    ...
    "menu.preview.see_full_menu": "See full menu",
    "menu.preview.categories_suffix": "categories",
    "menu.preview.more_item": "more item",
    "menu.preview.more_items": "more items",
    "menu.vote.favorite_badge": "Fan favorite",
    "menu.vote.login_required": "Log in to vote",
    "review.dishes_tested": "Which dishes did you try?",
    "review.dishes_vote_hint": "Like or dislike the dishes you tasted",
    ...
    // Ambassador Program
    "ambassador.program.title": "Ambassador Program",
    "ambassador.program.subtitle": "Recruit ambassadors and reward them for every booking generated",
    "ambassador.program.create": "Create a program",
    "ambassador.program.edit": "Edit program",
    "ambassador.program.config": "Program configuration",
    "ambassador.program.config_desc": "Your ambassador program settings",
    "ambassador.program.reward_description": "Reward description",
    "ambassador.program.reward_placeholder": "E.g.: A complimentary dinner for 2",
    "ambassador.program.conversions_required": "Conversions required",
    "ambassador.program.conversions_hint": "Number of confirmed bookings to unlock the reward",
    "ambassador.program.validity_days": "Validity (days)",
    "ambassador.program.validity_hint": "Duration to use the reward once unlocked",
    "ambassador.program.max_beneficiaries": "Max beneficiaries / month",
    "ambassador.program.confirmation_mode": "Confirmation mode",
    "ambassador.program.confirmation_manual": "Manual (from dashboard)",
    "ambassador.program.confirmation_qr": "QR Code (scan at reception)",
    "ambassador.program.active": "Program active",
    "ambassador.program.inactive": "Program inactive",
    "ambassador.program.no_program": "No ambassador program",
    "ambassador.program.no_program_desc": "Create a program to recruit ambassadors among your customers.",
    "ambassador.program.created": "Program created successfully!",
    "ambassador.program.updated": "Program updated",
    "ambassador.program.activated": "Program activated",
    "ambassador.program.deactivated": "Program deactivated",

    "ambassador.applications.title": "Applications",
    "ambassador.applications.all": "All",
    "ambassador.applications.pending": "Pending",
    "ambassador.applications.accepted": "Accepted",
    "ambassador.applications.rejected": "Rejected",
    "ambassador.applications.accept": "Accept",
    "ambassador.applications.reject": "Reject",
    "ambassador.applications.empty": "No applications",
    "ambassador.applications.rejection_reason": "Rejection reason",
    "ambassador.applications.confirm_accept": "Confirm acceptance",
    "ambassador.applications.confirm_reject": "Confirm rejection",

    "ambassador.conversions.title": "Conversions",
    "ambassador.conversions.confirm_presence": "Present",
    "ambassador.conversions.reject": "Absent",
    "ambassador.conversions.pending": "Pending",
    "ambassador.conversions.confirmed": "Confirmed",
    "ambassador.conversions.rejected": "Rejected",
    "ambassador.conversions.expired": "Expired",
    "ambassador.conversions.suspicious": "Suspicious",
    "ambassador.conversions.empty": "No conversions",

    "ambassador.rewards.title": "Rewards",
    "ambassador.rewards.mark_claimed": "Consume",
    "ambassador.rewards.active": "Active",
    "ambassador.rewards.claimed": "Consumed",
    "ambassador.rewards.expired": "Expired",
    "ambassador.rewards.claim_code": "Code",
    "ambassador.rewards.empty": "No rewards",
    "ambassador.rewards.consumed": "Reward consumed successfully",

    "ambassador.stats.title": "Statistics",
    "ambassador.stats.total_ambassadors": "Active ambassadors",
    "ambassador.stats.pending_applications": "Pending applications",
    "ambassador.stats.conversions_this_month": "Conversions this month",
    "ambassador.stats.active_rewards": "Active rewards",
    "ambassador.stats.total_conversions": "Conversions",
    "ambassador.stats.conversion_rate": "Conversion rate",
    "ambassador.stats.rewards_distributed": "Rewards distributed",
    "ambassador.stats.rewards_claimed": "Rewards consumed",
    "ambassador.stats.top_ambassadors": "Top 5 ambassadors",

    // Ambassador Consumer
    "ambassador.consumer.join_program": "Join the program",
    "ambassador.consumer.application_sent": "Application sent",
    "ambassador.consumer.you_are_ambassador": "You are an ambassador",
    "ambassador.consumer.application_rejected": "Application rejected",
    "ambassador.consumer.in_progress": "in progress",
    "ambassador.consumer.unlocked": "unlocked",
    "ambassador.consumer.confirmed_reservations": "confirmed bookings",
    "ambassador.consumer.view_qr": "View my QR code",
    "ambassador.consumer.your_reward": "Your reward",
    "ambassador.consumer.copied": "Copied!",
    "ambassador.consumer.expires_on": "Expires on",
    "ambassador.consumer.used_on": "Used on",
    "ambassador.consumer.empty_title": "No programs",
    "ambassador.consumer.empty_desc": "You haven't joined any ambassador program yet",
    "ambassador.consumer.pending_validation": "Pending validation",
    "ambassador.consumer.applied_on": "Applied on",
    "ambassador.consumer.programs_in_progress": "Programs in progress",
    "ambassador.consumer.pending_applications": "Pending applications",
    "ambassador.consumer.unlocked_rewards": "Unlocked rewards",
    "ambassador.consumer.rewards_history": "Rewards history",

    // Ambassador Admin
    "ambassador.admin.title": "Ambassador Program",
    "ambassador.admin.subtitle": "Overview of programs, conversions and fraud detection",
    "ambassador.admin.overview": "Overview",
    "ambassador.admin.programs": "Programs",
    "ambassador.admin.conversions": "Conversions",
    "ambassador.admin.fraud": "Fraud",
    "ambassador.admin.active_programs": "Active programs",
    "ambassador.admin.total_conversions": "Total conversions",
    "ambassador.admin.rewards_distributed": "Rewards distributed",
    "ambassador.admin.suspicious_conversions": "Suspicious conversions",
    "ambassador.admin.flag_suspicious": "Flag as suspicious",
    "ambassador.admin.force_confirm": "Force confirmation",
    "ambassador.admin.suspects_only": "Suspects only",
    "ambassador.admin.all_statuses": "All statuses",
    "ambassador.admin.filter_active": "Active",
    "ambassador.admin.filter_inactive": "Inactive",
    "ambassador.admin.filter_all": "All",
  };
