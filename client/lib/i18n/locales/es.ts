...
const es: Partial<Record<TranslationKey, string>> = {
    ...
    "menu.preview.see_full_menu": "Ver carta completa",
    "menu.preview.categories_suffix": "categorías",
    "menu.preview.more_item": "plato más",
    "menu.preview.more_items": "platos más",
    "menu.vote.favorite_badge": "Favorito",
    "menu.vote.login_required": "Inicia sesión para votar",
    "review.dishes_tested": "¿Qué platos probaste?",
    "review.dishes_vote_hint": "Dale like o dislike a los platos que probaste",
    ...
    // Ambassador Program
    "ambassador.program.title": "Programa de Embajadores",
    "ambassador.program.subtitle": "Recluta embajadores y recompénsalos por cada reserva generada",
    "ambassador.program.create": "Crear un programa",
    "ambassador.program.edit": "Editar programa",
    "ambassador.program.config": "Configuración del programa",
    "ambassador.program.config_desc": "Parámetros de tu programa de embajadores",
    "ambassador.program.reward_description": "Descripción de la recompensa",
    "ambassador.program.reward_placeholder": "Ej.: Una cena para 2 de regalo",
    "ambassador.program.conversions_required": "Conversiones necesarias",
    "ambassador.program.conversions_hint": "Número de reservas confirmadas para desbloquear la recompensa",
    "ambassador.program.validity_days": "Validez (días)",
    "ambassador.program.validity_hint": "Duración para usar la recompensa una vez desbloqueada",
    "ambassador.program.max_beneficiaries": "Máx. beneficiarios / mes",
    "ambassador.program.confirmation_mode": "Modo de confirmación",
    "ambassador.program.confirmation_manual": "Manual (desde el panel)",
    "ambassador.program.confirmation_qr": "Código QR (escaneo en recepción)",
    "ambassador.program.active": "Programa activo",
    "ambassador.program.inactive": "Programa inactivo",
    "ambassador.program.no_program": "Sin programa de embajadores",
    "ambassador.program.no_program_desc": "Crea un programa para reclutar embajadores entre tus clientes.",
    "ambassador.program.created": "¡Programa creado con éxito!",
    "ambassador.program.updated": "Programa actualizado",
    "ambassador.program.activated": "Programa activado",
    "ambassador.program.deactivated": "Programa desactivado",

    "ambassador.applications.title": "Candidaturas",
    "ambassador.applications.all": "Todas",
    "ambassador.applications.pending": "Pendientes",
    "ambassador.applications.accepted": "Aceptadas",
    "ambassador.applications.rejected": "Rechazadas",
    "ambassador.applications.accept": "Aceptar",
    "ambassador.applications.reject": "Rechazar",
    "ambassador.applications.empty": "Sin candidaturas",
    "ambassador.applications.rejection_reason": "Razón del rechazo",
    "ambassador.applications.confirm_accept": "Confirmar aceptación",
    "ambassador.applications.confirm_reject": "Confirmar rechazo",

    "ambassador.conversions.title": "Conversiones",
    "ambassador.conversions.confirm_presence": "Presente",
    "ambassador.conversions.reject": "Ausente",
    "ambassador.conversions.pending": "Pendiente",
    "ambassador.conversions.confirmed": "Confirmada",
    "ambassador.conversions.rejected": "Rechazada",
    "ambassador.conversions.expired": "Expirada",
    "ambassador.conversions.suspicious": "Sospechosa",
    "ambassador.conversions.empty": "Sin conversiones",

    "ambassador.rewards.title": "Recompensas",
    "ambassador.rewards.mark_claimed": "Consumir",
    "ambassador.rewards.active": "Activa",
    "ambassador.rewards.claimed": "Consumida",
    "ambassador.rewards.expired": "Expirada",
    "ambassador.rewards.claim_code": "Código",
    "ambassador.rewards.empty": "Sin recompensas",
    "ambassador.rewards.consumed": "Recompensa consumida con éxito",

    "ambassador.stats.title": "Estadísticas",
    "ambassador.stats.total_ambassadors": "Embajadores activos",
    "ambassador.stats.pending_applications": "Candidaturas pendientes",
    "ambassador.stats.conversions_this_month": "Conversiones este mes",
    "ambassador.stats.active_rewards": "Recompensas activas",
    "ambassador.stats.total_conversions": "Conversiones",
    "ambassador.stats.conversion_rate": "Tasa de conversión",
    "ambassador.stats.rewards_distributed": "Recompensas distribuidas",
    "ambassador.stats.rewards_claimed": "Recompensas consumidas",
    "ambassador.stats.top_ambassadors": "Top 5 embajadores",

    // Ambassador Consumer
    "ambassador.consumer.join_program": "Unirse al programa",
    "ambassador.consumer.application_sent": "Candidatura enviada",
    "ambassador.consumer.you_are_ambassador": "Eres embajador",
    "ambassador.consumer.application_rejected": "Candidatura rechazada",
    "ambassador.consumer.in_progress": "en curso",
    "ambassador.consumer.unlocked": "desbloqueadas",
    "ambassador.consumer.confirmed_reservations": "reservas confirmadas",
    "ambassador.consumer.view_qr": "Ver mi código QR",
    "ambassador.consumer.your_reward": "Tu recompensa",
    "ambassador.consumer.copied": "¡Copiado!",
    "ambassador.consumer.expires_on": "Expira el",
    "ambassador.consumer.used_on": "Usada el",
    "ambassador.consumer.empty_title": "Sin programas",
    "ambassador.consumer.empty_desc": "Aún no te has unido a ningún programa de embajadores",
    "ambassador.consumer.pending_validation": "Pendiente de validación",
    "ambassador.consumer.applied_on": "Solicitado el",
    "ambassador.consumer.programs_in_progress": "Programas en curso",
    "ambassador.consumer.pending_applications": "Candidaturas pendientes",
    "ambassador.consumer.unlocked_rewards": "Recompensas desbloqueadas",
    "ambassador.consumer.rewards_history": "Historial de recompensas",

    // Ambassador Admin
    "ambassador.admin.title": "Programa de Embajadores",
    "ambassador.admin.subtitle": "Vista general de programas, conversiones y detección de fraude",
    "ambassador.admin.overview": "Vista general",
    "ambassador.admin.programs": "Programas",
    "ambassador.admin.conversions": "Conversiones",
    "ambassador.admin.fraud": "Fraude",
    "ambassador.admin.active_programs": "Programas activos",
    "ambassador.admin.total_conversions": "Conversiones totales",
    "ambassador.admin.rewards_distributed": "Recompensas distribuidas",
    "ambassador.admin.suspicious_conversions": "Conversiones sospechosas",
    "ambassador.admin.flag_suspicious": "Marcar como sospechoso",
    "ambassador.admin.force_confirm": "Forzar confirmación",
    "ambassador.admin.suspects_only": "Solo sospechosos",
    "ambassador.admin.all_statuses": "Todos los estados",
    "ambassador.admin.filter_active": "Activos",
    "ambassador.admin.filter_inactive": "Inactivos",
    "ambassador.admin.filter_all": "Todos",
};
