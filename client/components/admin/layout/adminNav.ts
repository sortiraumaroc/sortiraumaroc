...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  },
  {
    ...
    icon: ClipboardList,
    matchPaths: ["/admin/ramadan", "/admin/ftour"],
  },
  ...
  { type: "link", label: "Ambassadeurs", to: "/admin/ambassadors", icon: Gift },
  {
    type: "link",
    label: "Paiements",
    to: "/admin/payments",
    icon: CreditCard,
    matchPaths: ["/admin/finance/payout-requests", "/admin/finance/quotes-invoices"],
  },
  { type: "link", label: "Partenariats", to: "/admin/partnerships", icon: Handshake },
  { type: "link", label: "Conciergeries", to: "/admin/conciergeries", icon: Landmark },
  {
    type: "link",
