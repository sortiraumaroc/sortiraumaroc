...
export function AdminMarketingProspectsPage() {
      ...
      <Dialog open={exportDialogOpen} onOpenChange={setExportDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Entrez le mot de passe de sécurité pour exporter les données
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <p className="text-sm font-medium">
              Vous allez supprimer {selectedIds.length} prospect(s).
            </p>
            <div>
              <Label>Mot de passe de sécurité</Label>
              <Input
...
export default AdminMarketingProspectsPage;
